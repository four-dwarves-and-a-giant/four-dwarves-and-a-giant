...
public class ListTester {
	...
	private void runTests() {
        ...
        if (SUPPORTS_LIST_ITERATOR) {
            ...
            // Scenario: 90
            testThreeElementList(AB_iter2PreviousAddC_ACB, "AB_iter2PreviousAddC_ACB", LIST_ACB, STRING_ACB);

            //3-element to changed 3-element via set()
            // Scenario: 96
            testThreeElementList(ABC_iter1NextSetD_ADC, "ABC_iter1NextSetD_ADC", LIST_ADC, STRING_ADC);
            // Scenario: 99
            testThreeElementList(ABC_iter2PreviousSetD_ADC, "ABC_iter2PreviousSetD_ADC", LIST_ADC, STRING_ADC);
    ...
    private Scenario<Integer> emptyList_addA_0A = () -> emptyList_addA_0A();
    ...
    /**
     * Scenario #50: [A,B,C] -> iterator, next(), next(), next(), remove() ->
     * [A,B]
     *
    ...
    /**
     * Scenario #51: [A,B,C] -> iterator, next(), remove(), next(), remove() ->
     * [C]
     *
    ...
    /**
     * Scenario #52: [A,B,C] -> iterator, next(), remove(), next(), next(),
     * remove() -> [B]
     *
    ...
    /**
     * Scenario #53: [A,B,C] -> iterator, next(), next(), remove(), next(),
     * remove() -> [A]
     *
    ...
    private Scenario<Integer> ABC_iterNextRemoveNextRemoveNextRemove = () -> ABC_iterNextRemoveNextRemoveNextRemove();
     ...
     /**
     * Scenario #57: [A,B] -> iterator, next(), remove()
     * next(), remove() -> [A]
     *
     * @return [A] after iterator, next(), remove()
     * 
     */
    private IndexedUnsortedList<Integer> AB_iterNextRemove_A() {
        IndexedUnsortedList<Integer> list = A_addtoRearB_AB();
    ...
    private Scenario<Integer> AB_iterNextRemove_A = () -> AB_iterNextRemove_A();

    /**
     * Scenario #60: [A,B,C] -> iterator, next(), remove()
     * next(), remove() -> [A,C]
     *
     * @return [A,C] after iterator, next(), remove()
     * 
     */
    private IndexedUnsortedList<Integer> ABC_iterNextRemove_AC() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        ListIterator<Integer> iterator = list.listIterator(1);
        iterator.next();
        iterator.remove();
    ...
    private Scenario<Integer> ABC_iterNextRemove_AC = () -> ABC_iterNextRemove_AC();

    /**
     * Scenario #66: [A] -> iterator, previous(), remove()
     * previous(), remove() -> []
     *
     * @return [] after iterator, previous(), remove()
     */
    private IndexedUnsortedList<Integer> A_iterPreviousRemove_0() {
        IndexedUnsortedList<Integer> list = emptyList_addA_0A();
        ListIterator<Integer> iterator = list.listIterator(1);
        iterator.previous();
        iterator.remove();
    ...
    private Scenario<Integer> A_iterPreviousRemove_0 = () -> A_iterPreviousRemove_0();

    /**
     * Scenario #71: [A,B,C] -> iterator, previous(), remove()
     * previous(), remove() -> [A,C]
     *
     * @return [A,C] after iterator, previous(), remove()
     */
    private IndexedUnsortedList<Integer> ABC_iterPreviousRemove_AC() {
        IndexedUnsortedList<Integer> list = emptyList_addA_0A();
    ...
    private Scenario<Integer> ABC_iterPreviousRemove_AC = () -> ABC_iterPreviousRemove_AC();


    /**
     * Scenario #: 87 [A,B] -> iterator(), next(), add(C) -> [A,C,B]
     *
     * @return [A,C,B] after iterator(), next(), add(C)
     */
    ...
    /**
     * Scenario #: 90 [A,B] -> iterator(2), previous(), add(C) -> [A,C,B]
     *
     * @return [A,C,B] after iterator(2), previous(), add(C)
     */
    private IndexedUnsortedList<Integer> AB_iter2PreviousAddC_ACB() {
        IndexedUnsortedList<Integer> list = A_addtoRearB_AB();
        ListIterator<Integer> iterator = list.listIterator(2);
        iterator.previous();
        iterator.add(ELEMENT_C);
    ...
    private Scenario<Integer> AB_iter2PreviousAddC_ACB = () -> AB_iter2PreviousAddC_ACB();

    /**
     * Scenario #: 96 [A,B,C] -> iterator(1), next(), set(D) -> [A,D,C]
     *
     * @return [A,D,C] after iterator(1), next(), set(D)
     */
    private IndexedUnsortedList<Integer> ABC_iter1NextSetD_ADC() {
        IndexedUnsortedList<Integer> list = AB_addAfterCB_ABC();
        ListIterator<Integer> iterator = list.listIterator(1);
        iterator.next();
    ...
    private Scenario<Integer> ABC_iter1NextSetD_ADC = () -> ABC_iter1NextSetD_ADC();

    /**
     * Scenario #: 99 [A,B,C] -> iterator(2), previous(), set(D) -> [A,D,C]
     *
     * @return [A,D,C] after iterator(2), previous(), set(D)
     */
    ...
    private Scenario<Integer> ABC_iter2PreviousSetD_ADC = () -> ABC_iter2PreviousSetD_ADC();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
        ...
        try {
            ...
            printTest(scenarioName + "_testAddToFront", testAddToFront(scenario.build(), ELEMENT_X, Result.NoException));
            printTest(scenarioName + "_testAddToRear", testAddToRear(scenario.build(), ELEMENT_X, Result.NoException));
            printTest(scenarioName + "_testAddAfter" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[1], ELEMENT_B, Result.NoException));
            printTest(scenarioName + "_testAddAfter" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_A, Result.NoException));
            printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_Z, ELEMENT_X, Result.NoSuchElement));
            printTest(scenarioName + "_testAddX", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
            printTest(scenarioName + "_testAddAtIndexNeg1", testAddAtIndex(scenario.build(), -1, ELEMENT_X, Result.IndexOutOfBounds));
            printTest(scenarioName + "_testAddAtIndex0", testAddAtIndex(scenario.build(), 0, ELEMENT_X, Result.NoException));
            printTest(scenarioName + "_testAddAtIndex1", testAddAtIndex(scenario.build(), 1, ELEMENT_X, Result.NoException));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
        ...
        try {
            ...
            if (SUPPORTS_LIST_ITERATOR) {
                ...
                printTest(scenarioName + "_testListIter1Previous", testListIterPrevious(WrapIt.prep(scenario.build(), 1).getListIterator(), contents[0], Result.MatchingValue)); //returns A
                printTest(scenarioName + "_testListIter2Previous", testListIterPrevious(WrapIt.prep(scenario.build(), 2).getListIterator(), contents[2], Result.MatchingValue)); //should return C
                printTest(scenarioName + "_testListIter3Previous", testListIterPrevious(WrapIt.prep(scenario.build(), 3).getListIterator(), contents[1], Result.MatchingValue)); //should return B
                printTest(scenarioName + "_testListIter0Next", testListIterNext(WrapIt.prep(scenario.build(), 0).getListIterator(), contents[0], Result.MatchingValue)); //returns A
                printTest(scenarioName + "_testListIter1Next", testListIterNext(WrapIt.prep(scenario.build(), 1).getListIterator(), contents[2], Result.MatchingValue)); // should return C
                printTest(scenarioName + "_testListIter2Next", testListIterNext(WrapIt.prep(scenario.build(), 2).getListIterator(), contents[1], Result.MatchingValue)); //should return B
    ...
    /**
     * Runs ListIterator's hasNext() method and checks result against
     * expectedResult
     *
     * @param iterator an iterator already positioned for the call to hasNext()
     * @param expectedResult
    ...
    /**
     * Runs ListIterator remove() method and checks result against
     * expectedResult
     *
     * @param iterator an iterator already positioned for the call to remove()
     * @param expectedResult
